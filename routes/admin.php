...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageCouponController')->name('package.')->prefix('package')->group(function(){
        ...
        Route::get('/feature/{id}', 'getFeateruresPackage')->name('feature');
        Route::post('/feature/save/{id?}', 'saveFeaturePackagage')->name('feature.save-update');
        Route::post('/feature/delete/{id}', 'delteFeaturePackage')->name('feature.delete');
    });
